...
import io.github.dunwu.module.system.dao.mapper.MenuMapper;
...
public class MenuDaoImpl extends BaseExtDaoImpl<MenuMapper, Menu> implements MenuDao {
    ...
    @Override
    public void exportDtoList(Collection<MenuDto> list, HttpServletResponse response) throws IOException {
    ...
    @Override
    public List<MenuDto> buildTreeList(Collection<MenuDto> list) {
    ...
    @Override
    public Object treeObject(List<Menu> menus) {
        List<Map<String, Object>> list = new LinkedList<>();
        menus.forEach(menu -> {
                if (menu != null) {
                    List<Menu> menuList = listByPid(menu.getId());
    ...
    @Override
    public List<MenuVo> buildFrontMenus(Collection<MenuDto> list) {
