...
import io.github.dunwu.module.system.dao.mapper.UserMapper;
...
public class UserDaoImpl extends BaseExtDaoImpl<UserMapper, User> implements UserDao {
    ...
    @Override
    public void exportDtoList(Collection<UserDto> list, HttpServletResponse response) throws IOException {
