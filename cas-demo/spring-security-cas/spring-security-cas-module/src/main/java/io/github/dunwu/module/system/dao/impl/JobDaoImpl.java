...
import io.github.dunwu.module.system.dao.mapper.JobMapper;
...
public class JobDaoImpl extends BaseExtDaoImpl<JobMapper, Job> implements JobDao {
    ...
    @Override
    public void exportDtoList(Collection<JobDto> list, HttpServletResponse response) throws IOException {
