...
// import io.github.dunwu.module.security.constant.LoginCodeEnum;
...
//         return DataResult.ok(SecurityUtil.getCurrentUser());
//     }
//
//     @ApiOperation("获取验证码")
...
//         authService.logout(jwtTokenUtil.getToken(request));
...
//         if (!entity.getId().equals(SecurityUtil.getCurrentUserId())) {
