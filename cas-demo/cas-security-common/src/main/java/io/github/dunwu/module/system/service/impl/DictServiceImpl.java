...
import io.github.dunwu.module.system.dao.DictDao;
import io.github.dunwu.module.system.dao.DictOptionDao;
import io.github.dunwu.module.system.entity.Dict;
import io.github.dunwu.module.system.entity.DictOption;
import io.github.dunwu.module.system.entity.dto.DictDto;
import io.github.dunwu.module.system.entity.dto.DictOptionDto;
import io.github.dunwu.module.system.service.DictService;
...
public class DictServiceImpl extends ServiceImpl implements DictService {
    ...
    @Override
    public Page<DictDto> pojoPageByQuery(Object query, Pageable pageable) {
        return dictDao.pojoPageByQuery(query, pageable, this::doToDto);
    }
    ...
    public void exportPage(Object query, Pageable pageable, HttpServletResponse response) {
        Page<DictDto> page = dictDao.pojoPageByQuery(query, pageable, DictDto.class);
