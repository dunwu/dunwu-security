...
import io.github.dunwu.module.system.service.DictOptionService;
...
public class DictOptionServiceImpl extends ServiceImpl implements DictOptionService {
    ...
    @Override
    public Page<DictOptionDto> pojoPageByQuery(Object query, Pageable pageable) {
        return dao.pojoPageByQuery(query, pageable, DictOptionDto.class);
    }
    ...
    public void exportPage(Object query, Pageable pageable, HttpServletResponse response) {
        Page<DictOptionDto> page = dao.pojoPageByQuery(query, pageable, DictOptionDto.class);
