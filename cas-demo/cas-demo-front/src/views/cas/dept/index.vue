  ...
  <div class="app-container">
    ...
    >
      <el-form ref="form" inline :model="form" :rules="rules" size="small" label-width="80px">
        ...
        <el-form-item label="部门权重" prop="sequence">
          <el-input-number
    ...
    >
      ...
      <el-table-column v-if="checkPer(['admin', 'dept:edit', 'dept:del'])" label="操作" width="130px" fixed="right">
        <template slot-scope="scope">
...
const defaultForm = { id: null, name: null, isTop: '1', subCount: 0, pid: 0, sequence: 999, enabled: 'true' }
export default {
  name: 'Dept',
  ...
  data() {
    return {
      ...
      rules: {
        ...
        sequence: [{ required: true, message: '请输入序号', trigger: 'blur', type: 'number' }]
      },
