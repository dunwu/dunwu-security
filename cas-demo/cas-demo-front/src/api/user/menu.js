...
export function superiorTreeList(idList) {
  ...
  return request({
    url: 'user/menu/superiorTreeList',
    method: 'post',
    data: ids
  })
}
...
export function childrenIds(id) {
  return request({
    url: 'user/menu/childrenIds?id=' + id,
    method: 'get'
  })
}
